...
static const u4_t DEVADDR =  0x26xxxxxx; // <-- Change this address for every node!

void os_getArtEui (u1_t* buf) { }
void os_getDevEui (u1_t* buf) { }
void os_getDevKey (u1_t* buf) { }

uint8_t coords[11]={0x9A,0xE1,0x07,0x41, 0xC5, 0x00, 0xCE, 0x09, 0x70, 0xC1, 0x9A};    //send buffer
